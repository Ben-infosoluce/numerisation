...
<template>
  <div class="relative w-full md:w-1/4">
    ...
    <input placeholder="Rechercher un véhicule" v-model="modelValue" :class="cn(
      'flex h-9 w-full rounded-md border  px-3 py-1 pr-10 text-sm shadow-sm transition-colors placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500',
      props.class,
    )
      " />
