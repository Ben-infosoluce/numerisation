<template>
    <div
        ...
        <h4 class="text-2xl font-bold tracking-tight">
            Duplicata <span v-if="props.dossier_lier"> / Post-Immatriculation </span>
        </h4>
    ...
    <div class="p-6  ">
        <Card class="h-full flex flex-col p-10 mx-auto">
            ...
            <div id="receipt">
                ...
                <div class="w-fit mx-auto space-y-2 text-gray-800 mx-auto mt-12 text-center">
                    <h2 class="text-xl font-semibold mb-3 text-center">Service : <span class="font-bold">Duplicata
                        </span> <span class="font-bold" v-if="props.dossier_lier"> / Post-Immatriculation </span>
                    </h2>
