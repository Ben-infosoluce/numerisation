<template>
    <div class="flex flex-col space-y-4 mx-8 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
        <h4 class="text-2xl font-bold tracking-tight">Duplicata / Post-immatriculation</h4>
    ...
    <div class="rounded-lg dark:border-gray-700">
        <main class="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
            <Card class="h-full flex flex-col">
                <h5 class="pl-8 pt-8">Duplicata / Post-immatriculation</h5>
                <!-- Formulaire initial -->
                ...
                <div v-else-if="vinStatus === 'found'" class="text-center space-y-8 p-8">
                    ...
                    <div class="text-center space-x-2 mt-4 m-4">
                        ...
                        <div class="text-center space-x-5 mt-4">
                            ...
                            <Link
                                :href="route('show.detail.view.pdc.duplicata', { vin: cleanVin(vin), selected: selected, mutation: mutation })">
...
//verifie s'il est eligible au duplicata et a la  poste immatriculation
const findVin = async () => {
