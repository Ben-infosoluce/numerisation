<template>
    ...
    <div
        ...
        <h4 class="text-2xl font-bold tracking-tight">
            Modifier Immatriculation Spéciale
        </h4>
...
const onSubmit = handleSubmit((values) => {
    ...
    console.log(form.value.typePersonne)
    // Validation pour les entreprises
    if (form.value.typePersonne != "Physique") {
    ...
    formDataSummary.value = {
        ...
        prefectureClient: form.prefecture_client,
        sousPrefectureClient: form.sous_prefecture_client,
        districtClient: form.district_client,
