                                ...
                                <TableRow v-for="(dossier, index) in dossiers" :key="index">
                                    ...
                                    <TableCell class="text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent>
                                                <Link :href="route('show.view.pdc.immatriculation', dossier.id)">
                                                <DropdownMenuItem>
                                                    <Eye class=" w-4 h-4 " />Détails
                                                </DropdownMenuItem>
                                                </Link>
                                                <Link :href="route('show.receipt.pdc.immatriculation', dossier.id)">
                                                <DropdownMenuItem>
...
async function fetchDossiers() {
    loading.value = true
    const url = new URL('/pdc/immatriculation/data', window.location.origin)
