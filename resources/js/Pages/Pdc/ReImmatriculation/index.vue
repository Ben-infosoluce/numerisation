                                ...
                                <TableRow v-for="(dossier, index) in dossiers" :key="index">
                                    ...
                                    <TableCell class="text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent>
                                                <Link :href="route('show.view.pdc.re.immatriculation', dossier.id)">
                                                <DropdownMenuItem>
                                                    <Eye class=" w-4 h-4 " />Détails
                                                </DropdownMenuItem>
                                                </Link>
                                                <Link :href="route('show.receipt.pdc.re.immatriculation', dossier.id)">
                                                <DropdownMenuItem>
                                                    <ReceiptText class=" w-4 h-4 " />Recépissé
                                                </DropdownMenuItem>
                                                </Link>
                                                <!-- <Link :href="route('show.edit.pdc.re.immatriculation', dossier.id)">
