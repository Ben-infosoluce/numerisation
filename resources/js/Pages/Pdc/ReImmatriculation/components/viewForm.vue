                    ...
                    <div class="">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl p-10 w-full shadow-2xl space-y-6 ">
                            ...
                            <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                                <h4 class="text-lg font-semibold mb-4">Service :
                                    <samp class="text-[#ca7600]"> {{ props.dossier.detail }}</samp>
                                </h4>
                                <!-- Motif de rejet -->
                            ...
                            <h4 class="text-lg font-semibold mb-4">Type de Personne :
                                <samp class="text-[#ca7600]"> {{ props.dossier.r_dossier_vehicule.physique_morale
                                }}</samp>
                            </h4>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <p><strong>Numéro d'immatriculation précédente :</strong> {{
                                        data.num_immatriculation_precedant }}</p>
                                    <p><strong>Cylindrée :</strong> {{ data.cylindree }}</p>
                                    <p v-if="props.dossier.reserverNumero"><strong>Numéro réservé :</strong> {{
                                        props.dossier.reserverNumero
                                        }}</p>
                                    <p v-if="props.dossier.numeroDiplomatique"><strong>Numéro diplomatique
                                            :</strong> {{
                                                props.dossier.numeroDiplomatique
                                            }}</p>
                            ...
                            <div v-if="data.type != 'Physique'">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <p><strong>Profession représentant :</strong> {{ data.ProfessionRepresantant }}
                                    </p>
                                    <p><strong>Date naissance représentant :</strong> {{
                                        data.DateNaissanceRepresantant
                                        }}</p>
