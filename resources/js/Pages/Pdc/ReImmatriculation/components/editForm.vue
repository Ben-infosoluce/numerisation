                ...
                <ScrollArea class="h-full w-full rounded-md border">
                    <div class="p-8">
                        ...
                        <form @submit="onSubmit">
                                ...
                                <div class="grid gap-3 md:grid-cols-2 md:gap-10 lg:grid-cols-3">
                                    ...
                                    <FormField v-slot="{ componentField }" name="num_immatriculation_precedant">
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="CI-0019AA" v-bind="componentField"
                                        ...
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="District 1" v-bind="componentField"
                                                    autocomplete="district" v-model="form.districtClient" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    </FormField>
                                        ...
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="prefecture 1" v-bind="componentField"
                                                    autocomplete="prefecture" v-model="form.prefectureClient" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    </FormField>
                                        ...
                                        <FormItem v-auto-animate>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Sous prefecture 1" v-bind="componentField"
                                                    autocomplete="SousPrefecture" v-model="form.sousPrefectureClient" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    </FormField>
                            ...
                            <div v-show="form.typePersonne != 'Physique'" class="mt-10">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                            ...
                                            <p><strong>District :</strong> {{ formDataSummary.districtClient }}</p>
                                            <p><strong>N° d'immatriculation :</strong> {{
...
const form = ref({
    ...
    type: data.type || '',
    prefectureClient: data.prefecture_client || '',
    sousPrefectureClient: data.sous_prefecture_client || '',
    districtClient: data.district_client || '',
    num_immatriculation_precedant: data.num_immatriculation_precedant || '',
    genre: data.genre || '',
    ptac: data.ptac || '',
    pu: data.pu || '',
    pv: data.pv || '',
...
const formSchema = toTypedSchema(z.object({
    ...
    num_immatriculation_precedant: z
        .string({
            required_error: "Le numéro d'immatriculation est obligatoire.",
        })
        .min(8, {
            message: "Le numéro d'immatriculation doit contenir au moins 8 caractères.",
        }),
    DateNaissance: z
        .string()
...
function submitFinal() {
    ...
    console.log(data.num_immatriculation_precedant)

    // Utiliser PUT ou PATCH pour la mise à jour
    axios.put(`/pdc/re/immatriculation/${data.id}/update`, data)
        .then(response => {
            ...
            if (res.success) {
                ...
                setTimeout(() => {
                    window.location.href = '/pdc/re/immatriculation';
                }, 1500);
            } else {
