                            ...
                            <TableRow v-for="(dossier, index) in dossiers" :key="index">
                                ...
                                <TableCell class="text-right">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent>
                                            <Link :href="route('show.view.pdc.post.immatriculation', dossier.id)">
                                            <DropdownMenuItem>
                                                <Eye class=" w-4 h-4 " />Détails
                                            </DropdownMenuItem>
                                            </Link>
                                            <Link :href="route('show.receipt.pdc.post.immatriculation', dossier.id)">
                                            <DropdownMenuItem>
                                                <ReceiptText class=" w-4 h-4 " />Reçu
                                            </DropdownMenuItem>
                                            </Link>
                                            <Link :href="route('show.edit.pdc.immatriculation', dossier.id)">
...
async function fetchDossiers() {
    const url = new URL('/pdc/re/immatriculation/data', window.location.origin)
