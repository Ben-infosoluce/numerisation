        ...
        <main class="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
            <Card class="h-full flex flex-col gap-4 p-10">
                ...
                <div class="flex flex-col space-y-4 py-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                    <h2>
                        <strong>Service : </strong>{{ dossier.r_dossier_services.nom_service }}
                    </h2>
                    <h2>
                        Statut du dossier :
                ...
                <h2>
                    ...
                    <template v-else-if="
                        dossier.detail && typeof dossier.detail === 'string'
                    ">
                ...
                <div>
                    ...
                    <div class="w-full grid gap-4 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
                        ...
                        ">
                            ...
                            <div>
                                <CustomFileUpload dropText="Reçu d’achat" previewText="Fichier sélectionné"
                                    :accept="acceptedImageTypes" @input="
                                        form.recu_achat = $event.target.files[0]
                                        " previewPlaceholder="Aucune image sélectionnée" :dossier="dossier"
                                        ...
                                        <div v-for="(option, index) in options" :key="index"
                                            ...
                                            :class="{
                                                'border-gray-300 bg-muted':
                                                    selected === option,
                                                'border-muted hover:border-gray-100':
                                                    selected !== option,
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                <CustomFileUpload dropText="Pièce d'identité" previewText="Fichier sélectionné"
                                    :accept="acceptedImageTypes" @input="
                                        form.piece_identite_en_cours_de_validite =
                                        $event.target.files[0]
                                        " previewPlaceholder="Aucune image sélectionnée" :dossier="dossier"
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                <CustomFileUpload dropText="Vignette" previewText="Fichier sélectionné"
                                    :accept="acceptedImageTypes" @input="
                                        form.vignette = $event.target.files[0]
                                        " previewPlaceholder="Aucune image sélectionnée" :dossier="dossier"
                            ...
                            <div>
                                <CustomFileUpload dropText="Assurance en cours de validité"
                                    previewText="Fichier sélectionné" :accept="acceptedImageTypes" @input="
                                        form.assurance_en_cours_de_validite =
                                        $event.target.files[0]
                                        " previewPlaceholder="Aucune image sélectionnée" :dossier="dossier"
                        ...
                        ">
                            <p>
                                RTI signalant la modification (usage,
                                couleur..)*
                            </p>
                            <div>
                                <CustomFileUpload dropText="RTI signalant la modification"
                                    previewText="Fichier sélectionné" :accept="acceptedImageTypes" @input="
                                        form.rti_modification =
                                        $event.target.files[0]
                                        " previewPlaceholder="Aucune image sélectionnée" :dossier="dossier"
                                    @file-selected="handleFile"
                ...
                <div v-if="
                    ...
                    'Post-immatriculation' &&
                    dossier.detail &&
                    dossier.detail.includes(
                        'Changement de propriétaire : MUTATION',
                    )
                ">
                    <div>
                        <h1 class="font-semibold mt-8 mb-5">
                            Changement de propriétaire : Mutation
                        </h1>
                        <div class="grid gap-4 md:gap-8 lg:grid-cols-3 xl:grid-cols-3 mt-3">
                            ...
                            <div class="space-y-2">
                                <p>
                                    Pièce d’identité de l’ancien propriétaire *
                                </p>
                                <CustomFileUpload dropText="Pièce d’identité de l’ancien propriétaire"
                                    previewText="Fichier sélectionné" :accept="acceptedImageTypes" @input="
                                        form.piece_ancien_proprietaire =
                                        $event.target.files[0]
                                        " previewPlaceholder="Aucune image sélectionnée" :dossier="dossier"
                                    @file-selected="handleFile"
                                    modal-title="Détails de la pièce d’identité de l’ancien propriétaire" />
                ...
                ">
                    <div>
                        <h1 class="font-semibold mt-8 mb-5">
                            Mutation (Replire uniquement s'il y a une mutation)
                        </h1>
                        <div class="grid gap-4 md:gap-8 lg:grid-cols-3 xl:grid-cols-3 mt-3">
                            <div class="space-y-2">
                ...
                <div v-if="dossier && dossier.r_dossier_vehicule">
                    ...
                    <div v-if="
                        dossier.r_dossier_vehicule.physique_morale !=
                        'Physique'
                    ">
                        <h1 class="font-semibold mt-8 mb-5">
...
const submitForm = async () => {
    ...
    try {
        const requiredFields = [
            ...
            {
                value: form.piece_identite_en_cours_de_validite,
                name: "Pièce d'identité",
            },
            { value: form.vignette, name: "Vignette" },
            {
                value: form.assurance_en_cours_de_validite,
                name: "Assurance en cours de validité",
            },
        ];
        ...
        isLoading.value = false; // ✅ Désactive le loader même en cas d'erreur
    }
};
</script>
