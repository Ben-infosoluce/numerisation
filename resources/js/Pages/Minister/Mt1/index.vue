                            ...
                            <TableBody>
                                ...
                                <template v-else>
                                    <TableRow v-for="(dossier, index) in dossiers" :key="index">
                                        ...
                                        <TableCell>{{ dossier.r_dossier_services.nom_service || '—' }}</TableCell>
                                        ...
                                        <TableCell class="text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent>
                                                    <!-- <Link :href="route('show.mt1.dossier.details', dossier.id)"
                                                        v-if="dossier.id_dossier_lier">
                                                    <DropdownMenuItem>
                                                        <Eye class=" w-4 h-4 " />Détails-{{ dossier.id_dossier_lier }}
                                                    </DropdownMenuItem>
                                                    </Link> -->
                                                    <Link :href="route('show.new.mt1.get.data', dossier.num_chrono)">
                                                    <DropdownMenuItem>
...
function navigateNumerisationNew() {
    router.visit("/minister/mt1/get/data");
    // window.location.href = "/minister/mt1/get/data";
}

// Récupération des données
async function fetchDossiers() {
    loading.value = true
    const url = new URL('/minister/mt1/get/data', window.location.origin)
