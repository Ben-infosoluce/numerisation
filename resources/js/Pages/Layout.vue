        ...
        <header class="bg-white shadow-md w-full z-50">
            <div class="flex  mx-auto px-4 lg:py-4 md:py-4 sm:py-4 py-3 text-start justify-between">
                ...
                <div class="flex items-center">
                    <UserNav name="John Doe" email="john.doe@example.com" avatarSrc="/avatars/john-doe.png"
                        avatarAlt="John Doe" avatarFallback="JD" />
            ...
            <aside id="sidebar-multi-level-sidebar"
                ...
                <div class="h-full px-3 py-4 overflow-y-auto  dark:bg-gray-800 bg-[#1C2434]">
                    <ul class="space-y-4 font-medium mt-6">
                        ...
                        <!-- <li>
                            <button type="button"
                                class="flex items-center w-full p-2 text-base text-white  hover:text-black  transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        ...
                        <li>
                            <a href="#"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Immatriculation
                                </span>
                                <!-- <span
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center p-2 text-white  hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black dark:group-hover:text-black"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Gestion des Sites</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Gestion Utilisateur</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <Link>
                            <a href="#"
                                class="flex items-center p-2 text-white  hover:text-black rounded-lg dark:text-white hover:bg-[#CA7600] dark:hover:bg-gray-700 group bg-[#CA7600]">
                                <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-white dark:group-hover:text-white"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap text-white hover:text-white">Sign In</span>
                            </a>
                            </Link>
                        </li>
